...
> Retro styled game | RPG - The frog will tell us what the point of the game is, 
> Pixelated frog?

## Transition state from the title screen to the game screen
> Once the frog has given us all the instructions for the game, it will transition to the game screen

> at the start, the fly is not visible. On mouse press, the frog will start to talk

### create a speech bubble [The bubble will be const because it will not change, it will only disappear after the user is done going through the dialogue]
