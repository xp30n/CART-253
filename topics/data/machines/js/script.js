...
const machines = [{
    type: "incinerator", // give the machine a name! 
    x: 0,
    y: 100,
    width: 100,
    height: 100,
...
// machine is just a placeholder name, it will take whatever value is called within the draw even if there is no machine variable! 